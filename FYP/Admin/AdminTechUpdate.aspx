<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/Admin.Master" CodeBehind="AdminTechUpdate.aspx.vb" Inherits="FYP.AdminTechUpdate" %>
...
&nbsp;&nbsp;
            ...
            <asp:TextBox ID="txtTechName" runat="server" Visible="false"></asp:TextBox>
            <br />
            <br />
