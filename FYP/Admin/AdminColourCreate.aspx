...
&nbsp;
            ...
            <br />
            <br />
            <asp:Label ID="lblTitleM" runat="server" Font-Bold="True" Font-Size="X-Large" Text="Create New Material"></asp:Label>
            <br />
            <br />
            <br />
...
&nbsp;
    ...
    <div style="margin-top:50px; margin-left:100px; float:left; height:auto " aria-orientation="horizontal">
            <asp:Label ID="lblTitleA" runat="server" Font-Bold="True" Font-Size="X-Large" Text="Create New Area"></asp:Label>
            <br />
            <br />
            <br />
...
&nbsp;
            ...
            <br />
            <br />
            <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Size="X-Large" Text="Create New Location"></asp:Label>
            <br />
            <br />
            <br />
